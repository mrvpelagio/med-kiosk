...
def qrscan_view(request, identifier):
    entry = get_object_or_404(StudentEntry, identifier=identifier)
    return render(request, 'blockinfo/qrscan_result.html', {'entry': entry})
